...
import {HeaderMode} from '@workday/canvas-kit-react-header/lib/types';
import {titleStyle} from '@workday/canvas-kit-react-header/lib/styles';
import {udeColors} from './constants';
  ...
  render() {
    const logoStyle = css({
      ...
      borderRight: `1px solid ${
        this.props.mode === 'primary' ? udeColors.soap400.primary : udeColors.soap400.secondary
      }`,
    });

    const titleColor = css({
      color: this.props.mode === 'primary' ? udeColors.blue : 'white',
    });
            ...
            >
              <g id="The-Dub/Dub/White-2" transform="translate(5.000000, 2.000000)">
                ...
                <path
                  ...
                  id="Fill-4"
                  fill={this.props.mode === 'primary' ? udeColors.blue : 'white'}
                />
              </g>
            </g>
          </svg>
        </span>
        <h2 className={cx(titleStyle, titleColor)}>{this.props.title}</h2>
      </React.Fragment>
    );
  }
}
